...
#warning the ILog interface is expected on the AssetManager
            AssetManager.Instance.Log(severity, "[Motivation Test]: {0}", msg);
        }
        ...
        public void Initialize()
        {
            ...
            {
#warning change bridge implementation (in UnitTestMotivation/Bridge.cs) for testing (IDataStoragePath and ILog - logging behaviour)
                //Adding the bridge
